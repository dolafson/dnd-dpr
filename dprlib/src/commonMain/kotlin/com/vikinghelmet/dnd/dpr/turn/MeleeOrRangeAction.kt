...
interface MeleeOrRangeAction {
    fun getBonusDamage(playerCharacter: PlayerCharacter, isBonusAction: Boolean): Int
    fun getBonusToHit(playerCharacter: PlayerCharacter, isBonusAction: Boolean): Int
