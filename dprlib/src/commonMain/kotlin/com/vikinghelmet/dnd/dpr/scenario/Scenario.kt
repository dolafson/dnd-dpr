...
)
{
    ...
    fun isSlotAvailable(spell: Spell): Boolean {
        ...
        if (spell.name == HuntersMark.nameWithWS) {
        ...
        val slotsUsed = getSpellsAcrossTurns().count { it.properties.Level == spell.properties.Level && it.name != HuntersMark.nameWithWS }
