...
enum class WeaponProperty(val supported: Boolean = false) {
    ...
    Ammunition, // You can use a weapon that has the Ammunition property to make a ranged
                ...
                // required is specified with the weapon's range. Each attack expends one piece
    ...
    Heavy,      // You have Disadvantage on attack rolls with a Heavy weapon if it's a Melee weapon
    ...
    Light(true),      // When you take the Attack action on your turn and attack with a Light weapon,
                ...
                // For example, you can attack with a Shortsword in one hand and a Dagger in the
                // other using the Attack action and a Bonus Action, but you don't add your Strength
                // or Dexterity modifier to the damage roll of the Bonus Action unless that modifier
                // is negative.

    Loading,    // You can fire only one piece of ammunition from a Loading weapon when you use an action,
                // a Bonus Action, or a Reaction to fire it, regardless of the number of attacks you can normally make.

    Range,      // A Range weapon has a range in parentheses after the Ammunition or Thrown property.
                // The range lists two numbers. The first is the weapon’s normal range in feet, and the
                // second is the weapon’s long range. When attacking a target beyond normal range, you have
    ...
    Versatile,  // A Versatile weapon can be used with one or two hands. A damage value in parentheses appears
