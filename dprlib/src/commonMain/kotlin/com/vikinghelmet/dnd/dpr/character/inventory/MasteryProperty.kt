...
enum class MasteryProperty {
    ...
    Cleave, // If you hit a creature with a melee attack roll using this weapon,
            ...
            // to that damage unless that modifier is negative. You can make this extra attack
            // only once per turn.
    ...
    Graze,  // If your attack roll with this weapon misses a creature, you can deal damage
            ...
            // This damage is the same type dealt by the weapon, and the damage can be increased
            // only by increasing the ability modifier.

    Nick,   // When you make the extra attack of the Light property, you can make it as part
            // of the Attack action instead of as a Bonus Action. You can make this extra attack
            // only once per turn.

    Push,	// If you hit a creature with this weapon, you can push the creature up to
    ...
    Slow,	// If you hit a creature with this weapon and deal damage to it, you can reduce
            ...
            // than once by weapons that have this property, the Speed reduction doesn’t exceed 10 feet.

    Topple,	// If you hit a creature with this weapon, you can force the creature to make a
            // Constitution saving throw (DC 8 plus the ability modifier used to make the attack roll
